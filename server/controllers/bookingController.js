...
//function to check availabiliy of selected seats for a movie
...
export const createBooking = async (req, res) => {
  try {
    ...
    if (!isAvailable) {
      return res.json({
        success: false,
        message: "No more seats are avialable",
      });
    }
    ...
    await booking.save();
    //Run inngest scheduler function to check payment staatus after 10 minutes
    await inngest.send({
...
//api to get occupied seats data
